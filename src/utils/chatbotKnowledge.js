...
export const PDF_KNOWLEDGE_ENTRIES = [
	...
	},
	{
		...
		textEn: 'The museum opens Monday to Friday from 10:00 a.m. to 5:30 p.m.\n\nSaturdays, Sundays, and holidays from 10:00 a.m. to 4:30 p.m.\n\nTicket prices are COP 18,000 for Colombian visitors, COP 46,000 for international visitors, and COP 14,000 for students and visitors over 62, with free admission for several local visitor groups.\n\nPlease note that food is only allowed in the cafe and restaurant areas. Photography is not allowed in the Botero galleries, and photos in other galleries should be taken without flash.',
	},
	{
